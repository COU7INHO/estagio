...
def create_pdf(img1, img2, img3, file_name):
    ...
    if r_stance_phase_duration > l_stance_phase_duration:
        pdf.cell(w=143, txt='A fase de apoio do membro direito, %.4ss, foi %.4s%% superior à da perna esquerda, %.4ss' % (
        ...
        pdf.cell(w=143, txt='A fase de apoio do membro esquerdo, %.4ss, foi %.4s%% superior à da perna direita, %.4ss' % (
...
def sides_comparison():
    ...
    st.write('> **Diferenças nas amplitudes de movimento**')
    ...
    if min(ankle_angle) < min(ankle_angle_2):
        ...
        st.write('O pé esquerdo teve mais %.4sª de flexão plantar' % (abs(min(ankle_angle_2) - min(ankle_angle))))
    ...
    if r_stance_phase_duration > l_stance_phase_duration:
        st.write('A fase de apoio do membro direito, %.4ss, foi %.4s%% superior à da perna esquerda, %.4ss' % (
                r_stance_phase_duration, (r_stance_phase_duration - l_stance_phase_duration) / r_stance_phase_duration * 100,
                l_stance_phase_duration))
    else:
        st.write('A fase de apoio do membro esquerdo, %.4ss, foi %.4s%% superior à da perna direita, %.4ss' % (
                l_stance_phase_duration, (l_stance_phase_duration - r_stance_phase_duration) / l_stance_phase_duration * 100,
                r_stance_phase_duration))
